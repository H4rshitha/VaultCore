...
export const SkeletonCard = ({ className = '', rows = 3 }) => {
  return (
    <div
      className={`bg-white dark:bg-[#0D1322] border border-slate-200 dark:border-slate-800/80 rounded-2xl p-6 shadow-sm dark:shadow-md ${className}`}
    >
...
export const SkeletonAccountCard = ({ className = '' }) => {
  return (
    <div
      className={`bg-white dark:bg-[#0D1322] border border-slate-200 dark:border-slate-800/80 rounded-2xl p-6 shadow-sm dark:shadow-md space-y-4 ${className}`}
    >
...
export const SkeletonTable = ({ rows = 5, cols = 4, className = '' }) => {
  return (
    <div
      className={`w-full overflow-hidden rounded-xl border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-[#0D1322] ${className}`}
    >
